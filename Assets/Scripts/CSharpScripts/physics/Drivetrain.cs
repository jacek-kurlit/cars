...
public class Drivetrain : MonoBehaviour {
	...
	{		
		...
		if (ratio == 0)
		{
			applyTorqueToCarBody(engineTorque, engineFrictionTorque);
		}
		else
		{
			applyTorqueToWheels(ratio,engineTorque,engineFrictionTorque);
		}
	...
	private void applyTorqueToWheels(float ratio, float engineTorque,float engineFrictionTorque){	
